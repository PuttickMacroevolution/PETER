## Puttick et al. 
## Take simulated data and pruned trees of all fossils, then estimate phylogenetic signal of mass extinctions
## using the phylo D statistic and estimate PGLS models of trait value ~ extinction
...
## for all 100 simulates, estimate phylo D statistic and PGLS models
	for(u in 1:100) {
		phy <- in.file[[u]][[1]]
	...
	write.csv(signif.difference.out, "../disparity.analysis/outputs/lm.phylo.d.csv")
	# names(output) <- all.files
	# saveRDS(signif.difference, file="../disparity.analysis/outputs/phy.d.lm.R")