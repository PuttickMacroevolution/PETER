## Puttick et al. 
## Estimate disparity in a series of time bins with disparity estimated using median pairwise euclidean distance, 
## median pairwise distance from the root,Sum Of Variances, and Sum Of Ranges using the dispRity package.
